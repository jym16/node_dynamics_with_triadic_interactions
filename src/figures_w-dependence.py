...
def main():
    ...
    identifiers = ["Ra+", "A1a+", "A2a+", "A3a+", "A4a+"]
    _bins = 50 # 'fd' if you want to use Freedman-Diaconis rule

    output_file = "./figure/comparison_w-dependence.pdf"
    ...
    w_pos = [2.0, 2.0e-1, 2.0, 2.0e1, 2.0e1]
    w_neg = [1.0, 1.0e-1, 1.0e-1, 1.0, 1.0e1]
    threshold = 1.0e-1
    alpha = 1.0e-1
    noise_std = 1.0e-1
    dt = 1.0e-2
